...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        // 方法1: 如果写到同一个sheet
        String fileName = TestFileUtil.getPath() + File.separator + "repeatedWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写
        try (ExcelWriter excelWriter = EasyExcel.write(fileName, EcGrossProfit.class).build()) {
            ...
            for (int j = 0; j < 10 ; j++) {
                ...
                CompletableFuture.runAsync(() ->{
                    ...
                    WriteSheet writeSheet = EasyExcel.writerSheet("模板"+ finalJ).build();
