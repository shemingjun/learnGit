...
<div ng-app>
    ...
    <div ng-controller="TestClientCtrl">
        <div class="well well-sm">
            请先输入client_secret: <input type="text" value="{{secret}}" placeholder="client_secret" ng-model="secret"
                ...
                <div class="panel-body">
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <form action="${contextPath}/oauth/token?client_id={{clientId}}&client_secret={{secret}}&grant_type=authorization_code&code={{code}}&redirect_uri={{redirectUri}}"
                                ...
                                <button class="btn btn-link" type="submit">
                                    /oauth/token?client_id={{clientId}}&client_secret={{secret}}&grant_type=authorization_code&code={{code}}&redirect_uri={{redirectUri}}
                                </button>
        ...
        <c:if test="${clientDetailsDto.containsPassword}">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="${contextPath}/oauth/token?client_id={{clientId}}&client_secret={{secret}}&grant_type=password&scope={{scope}}&username={{username}}&password={{password}}"
                          method="post" target="_blank">
                        ...
                        <button class="btn btn-link" type="submit">
                            /oauth/token?client_id={{clientId}}&client_secret={{secret}}&grant_type=password&scope={{scope}}&username={{username}}&password={{password}}
                        </button>
                        <span class="label label-warning">POST</span>
                    </form>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <p>
                        <a href="${contextPath}/oauth/authorize?client_id={{clientId}}&client_secret={{clientSecret}}&response_type=token&scope={{scope}}&redirect_uri={{implicitRedirectUri}}"
                           target="_blank"
                        >/oauth/authorize?client_id={{clientId}}&client_secret={{secret}}&response_type=token&scope={{scope}}&redirect_uri={{implicitRedirectUri}}</a>
                        <span class="label label-info">GET</span>
                    </p>
                </div>
            </div>
        ...
        <c:if test="${clientDetailsDto.containsClientCredentials}">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="${contextPath}/oauth/token?client_id={{clientId}}&client_secret={{secret}}&grant_type=client_credentials&scope={{scope}}"
                          method="post" target="_blank">
                        ...
                        <button class="btn btn-link" type="submit">
                            /oauth/token?client_id={{clientId}}&client_secret={{secret}}&grant_type=client_credentials&scope={{scope}}
                        </button>
                        <span class="label label-warning">POST</span>
                    </form>
                </div>
        ...
        <c:if test="${clientDetailsDto.containsRefreshToken}">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="${contextPath}/oauth/token?client_id={{clientId}}&client_secret={{secret}}&grant_type=refresh_token&refresh_token={{refreshToken}}"
                          method="post" target="_blank">
                        ...
                        <button class="btn btn-link" type="submit">
                            /oauth/token?client_id={{clientId}}&client_secret={{secret}}&grant_type=refresh_token&refresh_token={{refreshToken}}
                        </button>
                        <span class="label label-warning">POST</span>
                    </form>
                </div>
...
<script>
    var TestClientCtrl = ["$scope", function ($scope) {
        ...
        $scope.secret = "${clientDetailsDto.secret}";
